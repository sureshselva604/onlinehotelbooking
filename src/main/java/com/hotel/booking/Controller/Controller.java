...
public class Controller {
	...
	public ResponseEntity<String> createhoteldetails(@RequestBody Hotels hotel) {
		try
		{
		...
		{
			 return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("Failed to create hotel details");
        }
		
	}
	
	@PostMapping("admin/creatediscountdetails")
	public ResponseEntity<String> creatediscountdetails(@RequestBody Discount discount)
	{
		try
		{
	...
	public ResponseEntity<String> roomdetails(@RequestBody Room room) {
		try
		{
	...
	@GetMapping("user/AvailableRoomsForHotelId")
	public ResponseEntity<List<Room>> AvailableRoomsForHotelId(@RequestBody Room rooms)
	{
		try
		{
	...
	public ResponseEntity<List<Room>> totalRoomsForHotelId(@RequestBody Room rooms)
	{
		try
		{
	...
	public ResponseEntity<List<roomFacilities>> roomFacForRoomId(@RequestBody roomFacilities roomfac)
	{
		try
		{
	...
	public ResponseEntity<List<Hotels>> getFilterByStarRating(@PathVariable Double starRating )
	{
		try
		{
	...
	public ResponseEntity<List<Hotels>> getFilterByUserRating(@PathVariable Double userRating)
	{
		try
		{
	...
	public ResponseEntity<List<Room>> getFilterByPrice(@PathVariable Double minimumamount,@PathVariable Double maximumamount )
	{
		try
		{
