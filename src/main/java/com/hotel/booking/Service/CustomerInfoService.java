	 ...
	 public String addUser(User userInfo) { 
	     ...
	     userdet.add(userInfo);
		   ...
		   boolean result= userdet.stream().allMatch(userd->userd.getEmailId().matches(emailRegex)
		    		...
		    		&& userd.getConfirmPassword().matches(PassWordRegex));
          boolean matchespassword=userInfo.getConfirmPassword().equals(userInfo.getPassword());		   
		  
		 if(result && matchespassword)
		 {
